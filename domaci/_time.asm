...
check_digit:
  pusha
  cmp al, '0'
  jnge .invalid             ;ako nije veci ili jednak '0' nije validan (jnge = jump if not greater than or equal)
  cmp al, ah
  jnle .invalid             ;ako nije manji ili jednak od vrednosti u ah koja nam je ulaz (jnle = jump if not less than or equal)
...
.invalid:
  popa
  mov ah, 0                 ;ako je validna 0-ah vracamo rezultat ah=0
  ret


; --------------------------------------------
; provera formata vremena, da li je u HH:MM:SS
